...
def ols(trendline_options, x_raw, x, y, x_label, y_label, non_missing): # -> tuple[Any, Any, RegressionResultsWrapper]:
...
def lowess(trendline_options, x_raw, x, y, x_label, y_label, non_missing): # -> tuple[Unknown | ndarray[Any, dtype[Any]], Literal['<b>LOWESS trendline</b><br><br>'], None]:
