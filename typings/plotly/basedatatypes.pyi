...
class BaseFigure:
    ...
    def __reduce__(self): # -> tuple[type[BaseFigure], tuple[dict[str, Unknown]]]:
        """
    ...
    @property
    def layout(self): # -> list[Unknown] | list[Any] | tuple[Unknown, ...] | Any | BaseFigure:
        """
    ...
    def to_plotly_json(self): # -> dict[str, Unknown]:
        """
...
class BaseLayoutType(BaseLayoutHierarchyType):
    ...
    def __dir__(self): # -> list[SupportsRichComparison | str]:
        """
