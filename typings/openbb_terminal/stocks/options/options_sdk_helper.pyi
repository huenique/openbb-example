...
def get_full_option_chain(symbol: str, source: str = ..., expiration: Union[str, None] = ...) -> pd.DataFrame:
...
def get_option_current_price(symbol: str, source: str = ...): # -> float | Series:
...
@log_start_end(log=logger)
def hist(symbol: str, exp: str, strike: Union[int, Union[float, str]], call: bool = ..., source=...) -> pd.DataFrame:
...
def get_greeks(current_price: float, chain: pd.DataFrame, expire: str, div_cont: float = ..., rf: Optional[float] = ...) -> pd.DataFrame:
    """
...
class OptionsChains(Options):
    ...
    >>> xiu.get_straddle()
    """
    def __init__(self, symbol, source=..., date=..., pydantic=...) -> None:
        ...
    
    def __repr__(self) -> str:
        ...
    
    def get_stats(self, by=..., query=...): # -> DataFrame:
    ...
    def get_straddle(self, days=..., strike=...): # -> DataFrame:
    ...
    def get_strangle(self, days=..., moneyness=...): # -> DataFrame:
    ...
    def get_synthetic_long(self, days: Optional[int] = ..., strike: float = ...) -> pd.DataFrame:
    ...
    def get_synthetic_short(self, days: Optional[int] = ..., strike: float = ...) -> pd.DataFrame:
    ...
    def get_vertical_call_spread(self, days=..., sold_strike=..., bought_strike=...): # -> DataFrame:
    ...
    def get_vertical_put_spread(self, days=..., sold_strike=..., bought_strike=...): # -> DataFrame:
    ...
    def get_strategies(self, days: Optional[list[int]] = ..., straddle_strike: Optional[float] = ..., strangle_moneyness: Optional[float] = ..., synthetic_longs: Optional[list[float]] = ..., synthetic_shorts: Optional[list[float]] = ..., vertical_calls: Optional[list[float]] = ..., vertical_puts: Optional[list[float]] = ...): # -> DataFrame:
    ...
    def get_skew(self, expiration: Optional[str] = ..., moneyness: Optional[float] = ...): # -> DataFrame:
        """
    ...
    def chart_stats(self, by: str = ..., expiry: str = ..., oi: Optional[bool] = ..., percent: Optional[bool] = ..., ratios: Optional[bool] = ..., raw: bool = ..., export: str = ..., sheet_name: Optional[str] = ..., external_axes: bool = ...) -> Union[None, OpenBBFigure]:
    ...
    def chart_surface(self, option_type: str = ..., dte_range: Optional[list[int]] = ..., strike_range: Optional[list[float]] = ..., moneyness: Optional[float] = ..., oi: bool = ..., volume: bool = ..., raw: bool = ..., export: str = ..., sheet_name: Optional[str] = ..., external_axes: bool = ...) -> Union[None, OpenBBFigure]:
    ...
    def chart_skew(self, expirations: Optional[list[str]] = ..., moneyness: Optional[float] = ..., strike: Optional[float] = ..., atm: Optional[bool] = ..., otm_only: Optional[bool] = ..., raw: Optional[bool] = ..., export: Optional[str] = ..., sheet_name: Optional[str] = ..., external_axes: Optional[bool] = ...) -> Union[None, OpenBBFigure]:
    ...
    def chart_volatility(self, expirations: Optional[list[str]] = ..., moneyness: Optional[float] = ..., strike: Optional[float] = ..., oi: bool = ..., volume: bool = ..., raw: bool = ..., export: str = ..., sheet_name: Optional[str] = ..., external_axes: bool = ...) -> Union[None, OpenBBFigure]:
...
@log_start_end(log=logger)
def load_options_chains(symbol: str, source: str = ..., date: str = ..., pydantic: bool = ...) -> OptionsChains:
