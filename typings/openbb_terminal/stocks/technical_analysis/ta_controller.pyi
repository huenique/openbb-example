...
class TechnicalAnalysisController(StockBaseController):
    ...
    @log_start_end(log=logger)
    def call_recom(self, other_args: List[str]): # -> None:
    ...
    @log_start_end(log=logger)
    def call_clenow(self, other_args: List[str]): # -> None:
    ...
    @log_start_end(log=logger)
    def call_multi(self, other_args: List[str]): # -> None:
    ...
    @log_start_end(log=logger)
    def call_ichimoku(self, other_args: List[str]): # -> None:
