...
class StocksController(model.StocksRoot):
    ...
    """
    @property
    def ba(self): # -> StocksBehavioralAnalysis:
    ...
    @property
    def ca(self): # -> StocksComparisonAnalysis:
    ...
    @property
    def dps(self): # -> StocksDarkpoolShorts:
    ...
    @property
    def fa(self): # -> StocksFundamentalAnalysis:
    ...
    @property
    def options(self): # -> StocksOptions:
    ...
    @property
    def qa(self): # -> StocksQuantitativeAnalysis:
    ...
    @property
    def screener(self): # -> StocksScreener:
    ...
    @property
    def ta(self): # -> StocksTechnicalAnalysis:
    ...
    @property
    def th(self): # -> StocksTradingHours:
