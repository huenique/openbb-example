...
class CryptoController(model.CryptoRoot):
    ...
    """
    @property
    def dd(self): # -> CryptoDueDiligence:
    ...
    @property
    def onchain(self): # -> CryptoOnChain:
