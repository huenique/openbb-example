...
def no_data_message(error: str): # -> None:
    """Print message when no data available or error"""
    ...

@log_start_end(log=logger)
def get_gdp(countries: Optional[str] = ..., units: str = ..., start_date=..., end_date=...) -> pd.DataFrame:
    """
...
@log_start_end(log=logger)
def get_real_gdp(countries: Optional[List[str]], units: str = ..., start_date=..., end_date=...) -> pd.DataFrame:
    """
...
@log_start_end(log=logger)
def get_gdp_forecast(countries: Optional[List[str]], types: str = ..., units: str = ..., start_date=..., end_date=...) -> pd.DataFrame:
    """
...
@log_start_end(log=logger)
def get_debt(countries: Optional[List[str]], start_date=..., end_date=...) -> pd.DataFrame:
    """
...
@log_start_end(log=logger)
def get_cpi(countries: Optional[List[str]], perspective: str = ..., frequency: str = ..., units: str = ..., start_date=..., end_date=...) -> pd.DataFrame:
    """
...
@log_start_end(log=logger)
def get_balance(countries: Optional[List[str]], start_date=..., end_date=...) -> pd.DataFrame:
    """
...
@log_start_end(log=logger)
def get_revenue(countries: Optional[List[str]], units: str = ..., start_date=..., end_date=...) -> pd.DataFrame:
    """
...
@log_start_end(log=logger)
def get_spending(countries: Optional[List[str]], perspective: str = ..., units: str = ..., start_date=..., end_date=...) -> pd.DataFrame:
    """
...
@log_start_end(log=logger)
def get_trust(countries: Optional[List[str]], start_date=..., end_date=...) -> pd.DataFrame:
    """
