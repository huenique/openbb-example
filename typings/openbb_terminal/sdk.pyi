...
class OpenBBSDK:
    ...
    @property
    def crypto(self): # -> CryptoController:
    ...
    @property
    def econometrics(self): # -> EconometricsRoot:
    ...
    @property
    def fixedincome(self): # -> FixedincomeRoot:
    ...
    @property
    def forecast(self): # -> ForecastRoot:
    ...
    @property
    def forex(self): # -> ForexController:
        """Forex Submodule
    ...
    @property
    def stocks(self): # -> StocksController:
        """Stocks Submodule
