...
def generate_portfolio(symbols_categories: Optional[Dict[str, Dict[str, str]]] = ..., symbols_file_path: Optional[str] = ..., parameters_file_path: Optional[str] = ...) -> Union[PoEngine, None]:
...
@log_start_end(log=logger)
def load_parameters_file(portfolio_engine: PoEngine, parameters_file_path: str) -> Dict:
...
@log_start_end(log=logger)
def validate_inputs(portfolio_engine=..., kwargs=...) -> Tuple[List[str], PoEngine, dict]:
    """Check valid inputs
...
@log_start_end(log=logger)
def get_maxsharpe(portfolio_engine: Optional[PoEngine] = ..., **kwargs) -> Tuple[pd.DataFrame, Dict]:
...
@log_start_end(log=logger)
def get_minrisk(portfolio_engine: Optional[PoEngine] = ..., **kwargs) -> Tuple[pd.DataFrame, Dict]:
...
@log_start_end(log=logger)
def get_maxutil(portfolio_engine: Optional[PoEngine] = ..., **kwargs) -> Tuple[pd.DataFrame, Dict]:
...
@log_start_end(log=logger)
def get_maxret(portfolio_engine: Optional[PoEngine] = ..., **kwargs) -> Tuple[pd.DataFrame, Dict]:
...
@log_start_end(log=logger)
def get_maxdiv(portfolio_engine: Optional[PoEngine] = ..., **kwargs) -> Tuple[pd.DataFrame, Dict]:
...
@log_start_end(log=logger)
def get_maxdecorr(portfolio_engine: Optional[PoEngine] = ..., **kwargs) -> Tuple[pd.DataFrame, Dict]:
...
@log_start_end(log=logger)
def get_blacklitterman(portfolio_engine: Optional[PoEngine] = ..., **kwargs) -> Tuple[pd.DataFrame, Dict]:
    """Optimize decorrelation weights
...
@log_start_end(log=logger)
def get_ef(portfolio_engine: Optional[PoEngine] = ..., **kwargs) -> Tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame, pd.DataFrame, Optional[pd.DataFrame], NDArray[floating], NDArray[floating], rp.Portfolio,]:
...
@log_start_end(log=logger)
def get_riskparity(portfolio_engine: Optional[PoEngine] = ..., **kwargs) -> Tuple[pd.DataFrame, Dict]:
...
@log_start_end(log=logger)
def get_relriskparity(portfolio_engine: Optional[PoEngine] = ..., **kwargs) -> Tuple[pd.DataFrame, Dict]:
...
@log_start_end(log=logger)
def get_hrp(portfolio_engine: Optional[PoEngine] = ..., **kwargs) -> Tuple[pd.DataFrame, Dict]:
...
@log_start_end(log=logger)
def get_herc(portfolio_engine: Optional[PoEngine] = ..., **kwargs) -> Tuple[pd.DataFrame, Dict]:
...
@log_start_end(log=logger)
def get_nco(portfolio_engine: Optional[PoEngine] = ..., **kwargs) -> Tuple[pd.DataFrame, Dict]:
...
@log_start_end(log=logger)
def show(portfolio_engine: PoEngine, category: Optional[str] = ...) -> Union[pd.DataFrame, pd.DataFrame]:
