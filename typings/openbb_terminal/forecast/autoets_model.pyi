...
def get_autoets_data(data: Union[pd.Series, pd.DataFrame], target_column: str = ..., seasonal_periods: int = ..., n_predict: int = ..., start_window: float = ..., forecast_horizon: int = ...) -> Tuple[Optional[List[type[TimeSeries]]], Optional[List[type[TimeSeries]]], Optional[List[type[TimeSeries]]], Optional[float], Optional[StatsForecast],]:
